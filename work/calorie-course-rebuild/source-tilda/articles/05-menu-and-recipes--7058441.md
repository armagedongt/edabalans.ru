...
Поэтому планирование как целого меню так и отдельных рецептов и подгонка этих рецептов под нужные калории — это основа вашего обучения. Планировать рацион можно и в тетрадке в клеточку и в гугл табличке, но есть полезный сайт Calorizator.ru, где это всё в 100 раз удобнее. Я человек-компьютер — пользуюсь им очень активно и вам советую, потому что такого функционала нигде не встречал в бесплатном доступе.
...
В своей работе я иногда использую Health-diet.ru, но там без 100г не разберешься, нужен хоть и дешевый, но всё же платный аккаунт, поэтому для "домашнего" использования я бы советовал только FatSecret и Calorizator.ru.
