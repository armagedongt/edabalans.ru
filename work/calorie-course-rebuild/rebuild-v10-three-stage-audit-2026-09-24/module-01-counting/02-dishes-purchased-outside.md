...
### Три наглядных примера вне дома

**Заказ в сетевом фастфуде.** Сначала откройте официальную карточку именно вашей позиции и размера. Бургер, большая картошка и капучино — это три отдельные записи, а не абстрактный «комбо-обед». Если напиток можно собрать на разном молоке, с сахаром или сиропом, уточните выбранный вариант. У сетей состав и масса порций меняются, поэтому цифру из чужого дневника пятилетней давности не надо выдавать за сегодняшнюю.

**Латте в кофейне.** Спросите объём, вид и количество молока, число порций сиропа и есть ли сахар. Если сотрудник не знает калорийность, соберите оценку по компонентам: эспрессо почти ничего не решает, основной вклад дают молоко, сироп, сливки и посыпка. Фраза «это всего лишь кофе» не отменяет того, что большой сладкий напиток иногда ближе к десерту.

**Блюдо в небольшом кафе.** Попросите назвать выход порции и основные ингредиенты. Не стесняйтесь: вы не требуете раскрыть семейный секрет соуса, вам нужны вес, способ приготовления и заметные источники жира. Если точной карты не дают, сфотографируйте блюдо, выберите два-три близких аналога и возьмите не самый приятный, а самый правдоподобный диапазон.

| Что удалось узнать | Как занести |
|---|---|
| Есть официальные БЖУ и масса вашей порции | Записать официальную позицию и проверить размер |
| Известны объём и состав напитка | Посчитать молоко, сироп, сахар и добавки отдельно |
| Известны только вес и способ приготовления | Выбрать близкое блюдо с похожей жирностью |
| Не известно почти ничего | Сделать фото, взять диапазон аналогов, выбрать рабочую оценку и пометить неопределённость |

Спрашивать — нормальный способ считать. Стесняться, молча выбрать в приложении самый диетический вариант, а потом строить на нём дефицит — значительно более странный способ поведения.
...
Если половина вашего рациона состоит из новых сложных блюд, которые каждый раз приходится разбирать заново, проблема уже не в приложении. Это хороший повод постепенно найти несколько повторяемых оснований: знакомый завтрак, один омлет, понятный суп, любимую шаурму. Полный каталог такой еды мы начнём собирать уже в пятом материале этапа. Сейчас достаточно увидеть, где у вас каждый день начинается новая бухгалтерия.
