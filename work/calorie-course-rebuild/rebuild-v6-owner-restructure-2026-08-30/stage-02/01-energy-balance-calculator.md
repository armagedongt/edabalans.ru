...
## Один человек, три состояния модели

Возьмём выдуманную женщину: 38 лет, рост 168 см, вес 79 кг, приблизительно 35% жира, в среднем 90 г белка. Это не клиентский кейс и не обещание результата. Параметры нужны, чтобы последовательно показать механику нынешнего калькулятора.

Сначала она вводит 4500 шагов, 25% активных шагов, ноль тренировок и нулевой дефицит. Калькулятор показывает:

- базовый метаболизм — 1459 ккал;
- повседневная активность — 156 ккал;
- термический эффект пищи — 76 ккал;
- общий энергетический баланс — 1692 ккал.

![Исходный расчёт женщины без тренировок](../media/calculator-example/01-baseline.png)

Это не «её вечная норма». Это описание нынешнего варианта жизни в рамках формул калькулятора.

Затем она рассматривает другой режим: 8000 шагов, половина шагов активные, тренировочный расход 1200 ккал в неделю. Средний тренировочный вклад получается 171 ккал в день, а общий расчётный баланс поднимается до 2015 ккал.

![Расчёт после добавления шагов и тренировок](../media/calculator-example/02-activity.png)

Разница 323 ккал появилась не потому, что «разогнался метаболизм». Мы изменили конкретные слагаемые: дистанцию, характер шагов и тренировочный расход.

Наконец, при дефиците 450 ккал приложение показывает потребление 1565 ккал, расчётный темп около 420 г в неделю и 5,4 кг за 90 дней.

![Расчёт после назначения дефицита](../media/calculator-example/03-deficit.png)

На этом материале не надо повторять последнюю цифру. Важно увидеть порядок: сначала человек → затем повседневная активность → затем тренировки → и только потом дефицит. Если начать сразу с желаемого веса и красивого срока, калькулятор превращается в генератор обещаний.
...
![Из каких частей складывается общий расход энергии](assets/10-energy-balance-001.png)
...
![Грубая визуальная шкала процента жира для выбора диапазона](assets/10-energy-balance-006.png)
