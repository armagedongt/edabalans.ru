---
title: "Ходить, чтобы худеть"
slug: "hodit-chtoby-hudet"
excerpt: "Почему ходьба помогает похудению, сколько энергии она действительно расходует и где заканчивается польза идеи «просто больше ходить»."
category: "Тренировки"
visibility: "public"
...
---
Почти под каждым моим постом есть популярный комментарий, начинающийся со слов "долго не мог похудеть, пока не начал больше ходить". Но почему шаги?
...
Базовый минимум абсолютно для всех — 4000 шагов, а лучше 5000 шагов. И только когда вы сможете сделать это частью вашей жизни, можете начинать думать о более высоких материях типа учета калорий, рецептов и пищевых привычек.

![Иллюстрация к материалу «Ходить, чтобы худеть»](/media/hodit-chtoby-hudet/02.webp)
...
## Уровень 3. Активная фаза похудения

![Иллюстрация к материалу «Ходить, чтобы худеть»](/media/hodit-chtoby-hudet/03.webp)
...
Подробнее об этом — в материале «Сколько времени нужно на похудение?».
