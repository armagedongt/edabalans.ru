...
Нормализованный снимок: [Google Sheet](https://docs.google.com/spreadsheets/d/1lcuFzG8T4aHhctCE5PXPjc3IjVnXhzUptrX_silrVIE/edit).
Актуальные данные Валентины: [персональная рабочая таблица](https://docs.google.com/spreadsheets/d/1iOy9BV-FeB9tXqQTgRgysGOFl3G9IAUQY2tcoU-Eqzs/edit),
вкладка `Силовые Версия 2! (актуальная)`.
...
На 08.09.2026 нормализованный снимок отстаёт от рабочей таблицы. Импорт актуальной
вкладки ищет упражнения по вертикальным заголовкам и каждую колонку `План`; фиксированный
шаг между тренировками запрещён, потому что промежуточные столбцы расположены неровно.
Если в строке названия упражнения внутри следующей группы тренировки указано точное название
другого известного упражнения, с этой группы начинается новое упражнение, а последующие пустые
ячейки продолжают его. Такой маркер не переносится в заметку; прочий текст в этой строке
сохраняется как заметка к тренировке.
