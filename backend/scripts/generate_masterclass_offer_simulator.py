...
submit.onclick=search;input.onkeydown=function(event){if(event.key==='Enter'){event.preventDefault();search();}};
    ...
    page = f"""<!doctype html>
<html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Предпросмотр дополнительных предложений · edabalans</title><link rel="icon" type="image/svg+xml" href="/admin/static/admin-favicon.svg"><style>{PAGE_CSS}</style></head>
