...
def admin_asset(
    request: Request,
    asset_name: str = ApiPath(pattern="^(admin\\.css|admin\\.js|admin-shell\\.css|admin-shell\\.js|admin-session\\.css|admin-login\\.css|admin-login\\.js|marketing\\.css|knowledge-base\\.css|knowledge-base\\.js|knowledge-library\\.css|knowledge-library\\.js|course-structure-editor\\.css|course-structure-editor\\.js|product-catalog-editor\\.js|content-catalog\\.css|content-catalog\\.js)$"),
    credentials: HTTPBasicCredentials | None = Depends(security),
) -> FileResponse:
