...
mcp = FastMCP(
    "edabalans knowledge",
    instructions=(
        "Единая карта контента edabalans.ru. Сначала ищи карту и полные источники, "
        "не пиши по сниппетам. Смысловые совпадения не объединяй автоматически. "
...
def prepare_editorial_context(
    ...
    """Собери карту источников и границу раскрытия перед текстовой или продуктовой задачей."""
    with SessionLocal() as db:
        return task_context(
