...
LEGAL_DOCUMENTS = (
    {
        ...
        "summary": (
            ...
            "характер. Они не являются медицинской услугой, диагностикой или "
            "назначением лечения. При заболеваниях, симптомах и назначениях врача "
            "медицинские рекомендации имеют приоритет перед любыми советами из "
            "материалов проекта."
        ),
    },
    {
        ...
        "summary": (
            "В личном кабинете сохраняются данные аккаунта и покупок, прогресс, "
            "ответы на анкеты, дневники и сведения, которые вы сами вносите для "
            "работы с программами. Они нужны, чтобы выдавать доступ, сохранять "
            "результаты и поддерживать вас по ходу обучения."
        ),
    },
)
