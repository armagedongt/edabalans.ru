...
def app_fragment(app_code: str) -> FileResponse:
    if app_code not in {"dqs", "strength", "metabolism", "masterclass-course", "masterclass-sales", "onboarding-questionnaire", "masterclass-offers", "recipes-part-1", "recipes-part-2", "closing-review", "personal-access"}:
