...
def app_fragment(app_code: str) -> Response:
    if app_code not in {"account", "dqs", "strength", "metabolism", "recipes", "masterclass-course", "calories-course", "masterclass-sales", "onboarding-questionnaire", "masterclass-offers", "recipes-part-1", "recipes-part-2", "closing-review", "personal-access", "video-player", "sprints"}:
...
BASE_STRENGTH_EXERCISES: tuple[dict[str, Any], ...] = (
    ...
    {"code": "assisted-pull-up", "name": "Подтягивания в гравитроне", "muscles": "Широчайшие, бицепс, мышцы лопаток", "tips": ["Подберите помощь так, чтобы сохранять полную амплитуду.", "Начинайте движение опусканием лопаток.", "Не отталкивайтесь коленями от платформы."]},
    {"code": "lat-pulldown", "name": "Тяга верхнего блока сидя", "muscles": "Широчайшие, бицепс, мышцы лопаток", "tips": ["Начните движение опусканием лопаток.", "Тяните рукоять к верхней части груди.", "Не раскачивайте корпус."]},
    ...
    {"code": "one-arm-dumbbell-row", "name": "Тяга гантели в наклоне", "muscles": "Широчайшие, середина спины, задняя дельта", "tips": ["Зафиксируйте корпус и нейтральную спину.", "Тяните локоть к тазу, не разворачивая плечи.", "Опускайте гантель подконтрольно до комфортного растяжения."]},
    ...
    {"code": "triceps-pushdown", "name": "Тяга верхнего блока на трицепс", "muscles": "Трицепс", "tips": ["Зафиксируйте локти у корпуса.", "Разгибайте руки без движения плеча.", "Возвращайте рукоять подконтрольно."]},
    ...
    {"code": "incline-seated-dumbbell-curl", "name": "Подъём гантелей на бицепс сидя на наклонной скамье", "muscles": "Бицепс, плечевая мышца", "tips": ["Прижмите спину к наклонной скамье и опустите плечи.", "Сохраняйте локти неподвижными.", "Опускайте гантели медленно до комфортного разгибания рук."]},
)
