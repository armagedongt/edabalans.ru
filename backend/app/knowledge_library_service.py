...
def task_context(
    ...
    return {
        ...
        "use_policy": policy,
        "required_workflow": [
            "Сначала выбрать ближайшую принятую качественную авторскую основу; raw-предки нужны для пробелов, контекста, provenance и конфликтов.",
            "Открыть полный URI каждого выбранного источника, а не писать по сниппетам.",
