...
| 7 | Структура описана в `course/course.json`; часть рецептов и продуктовые разборы находятся вне текущего архива мастер-класса | Вступительный ролик «Едим то, что любим», интерфейс базы, первые рецепты, разбор продуктов; рекомендация ПП-батончиков пока необязательна |
| 8 | Пауза и переход описаны в `course/course.json` | Короткий текст «С сегодняшнего дня начинаем менять питание» и план следующих тем |
| 9 | `23-hunger-and-satiety-video.md`; редакторский источник и готовая статья `../../work/content-authoring-system/md-migration/day-09-hunger-guide.md`; `25-assignment-hunger-satiety-pause.md` | Гайд по эмоциональному голоду собран из полного транскрипта и опубликован |
| 10 | `35-five-rules-for-reducing-sweets-video.md`; `27-added-sugar-guide.txt`; `51-sugar-norms.md`; `36-assignment-added-sugar.md` | План, отдельные нормы и подробный гайд собраны и опубликованы |
...
| 12 | `30-breakdowns-overeating-cheat-meals.txt`; `38-cheat-meals-audio.md`; `39-assignment-breakdowns-and-cheat-meals.md` | Основная статья и отдельный дополнительный материал с двумя аудио, таймингами и письменной версией опубликованы |
...
редакторской сборки всех 20 дней.
