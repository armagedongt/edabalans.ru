...
TRIGGERS = [
    {
        ...
        "title": "01 · После анкеты — данные клиента и ответы",
        "trigger": "onboarding_questionnaire_completed",
        "condition": "Начальная анкета отправлена; Telegram или MAX уже подключён к личному кабинету",
        "recipient": "Участник, который отправил начальную анкету",
        "purpose": "Показать email, тариф, дату покупки, ссылку на личный кабинет и полную анкету.",
    },
    {
        "step_key": "pp_questionnaire",
        "content_code": "tpl_postpurchase_questionnaire",
        "title": "02 · После анкеты — просьба переслать сообщения",
        "trigger": "onboarding_questionnaire_completed",
        "condition": "Сразу после блока с данными клиента",
        "recipient": "Тот же клиент",
        "purpose": "Попросить переслать Сергею сообщение с данными и заполненной стартовой анкетой.",
    },
    {
    ...
    },
    {
        ...
        "condition": "DQS впервые раскрыт в четвёртом дне; Telegram подключён и доступ к мастер-классу действует",
    ...
    },
    {
        ...
        "recipient": "Клиент с подключённым Telegram и действующим доступом",
