...
async function sequence(code) {
  ...
  document.querySelector('#back').onclick = () => show('sequences'); document.querySelector('#show-map').onclick = () => mapView(null,code); const pane = document.querySelector('#step-pane');
