...
После production-выпуска 09.09.2026 endpoint обязан сообщать
`telegram_route=relay`: успешный polling подтверждает путь от российской VM через
закрытый Cloudflare relay до Telegram. Европейский Squid больше не входит в
рабочую цепочку бота.
