...
В целевой версии ссылки назначают накопительные канонические теги источника,
размещения и кампании без перезаписи предыдущих; отдельного понятия `последнее
касание` не будет. Русские названия тегов связываются с ASCII UTM/codes через
справочник, подробнее в `plans/TELEGRAM_START_LINKS_SPEC.md`.
