...
8. Между двумя текстами этапа 3 открывается существующее приложение
   ...
   Пользовательский API калькулятора проверяет завершение этапа 2 и действующий
   `ACCESS_CALORIES`, а не просто открытие этапа. Карточка приложения в ЛК
   показывает условие до разблокировки. Ремонт курса этим правилом не снимается.
