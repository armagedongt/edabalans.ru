...
4. Анкета завершается после сохранения/отправки. Шаг DQS завершается, когда
   участник открыл приложение и успешно сохранил значения минимум в двух строках.
   Туториал остаётся обязательной инструкцией в тексте дня, но отдельного второго
   состояния в DQS не создаётся. После возврата в день 4 открываются задание и
   дальнейший переход. Финальное саморевью завершается после отправки. Рецепты и
