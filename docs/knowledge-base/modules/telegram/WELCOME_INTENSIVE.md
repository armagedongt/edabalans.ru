...
Статус: `current`
Состояние внедрения: `in_development`; новая версия готовится к production при
включённом maintenance и начинает массовую работу только после owner-теста.
...
человека в `prepurchase_nurture`.
...
`products.intensive`, а не Telegram.
