...
посещения сохранены. Уже известный владелец мастер-класса отсеивается Start-router,
а покупка во время прохождения обрабатывается общим lifecycle-событием.
