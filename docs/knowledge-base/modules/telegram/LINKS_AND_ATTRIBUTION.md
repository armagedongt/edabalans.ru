...
- источник: точный существующий тег CRM, например `Источник Пикабу`;
...
|---|---|---|
| `c5a79797-d6c6-4a36-8551-b07443e990a7` | частая главная ссылка с Пикабу; обычный корневой start | источник Пикабу подтверждён; точный существующий `tag_id` выбрать из CRM при реализации |
| `120385af-6025-49f9-b586-d01f4ca4d36b` | отдельный пост «не с похудения»; обычный корневой start | рабочее название владельца сохранено; точные источник/тег/название размещения уточнить по каталогу |
| `b1514e43-2459-456f-949b-5cc25e87bb10` | отдельный пост про скорость похудения; обычный корневой start | размещение известно; точный существующий `tag_id` выбрать из CRM при реализации |
...
Стандартное окно привязки покупки к клику — 30 дней. First-party cookie браузера
хранится до 365 дней, если это допускают утверждённые правила обработки данных.
