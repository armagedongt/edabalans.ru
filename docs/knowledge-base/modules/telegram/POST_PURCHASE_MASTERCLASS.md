...
До середины консультация не продвигается ботом. После второй части рецептов/середины
бот может вести на максимальный пакет со всеми недостающими цифровыми продуктами и
консультацией. Через 3–4 дня после первой части рецептов, через 48 часов после
второй части и через 48 часов после саморевью ступень выгоды уменьшается. После
последней недели остаются стандартные цены, а автоматический дожим консультации
прекращается.
