...
|---|---|---|
| Старт и атрибуция | `START_WELCOME_ROUTING.md` | реализован локально: проверки, навигация, кружок, кнопка и выход в Welcome; deploy ожидается |
...
| Welcome: четыре дня интенсива | `WELCOME_INTENSIVE.md` | отдельная исполняемая цепочка из 8 сообщений; deploy ожидается |
...
единого модуля «Старт и атрибуция». Навигационный закреп, кружок, приветственный
пост, кнопка и стартовая проверка подписки также относятся к Start. Его зелёный
выход передаёт управление в отдельный Welcome, который начинается с Дня 1.
