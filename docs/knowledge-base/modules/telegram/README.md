...
|---|---|---|
| Старт и атрибуция | `START_WELCOME_ROUTING.md` | требования утверждены, реализация частичная |
...
| Welcome и первая часть интенсива | `WELCOME_INTENSIVE.md` | следующий в разработке |
...
отдельный глобальный модуль Welcome; внутренние шаги Welcome в стартовой схеме не
дублируются.
