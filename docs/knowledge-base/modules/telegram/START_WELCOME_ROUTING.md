...
Контент: `tpl_intensive_entry_delivered`. Показывает персональную кнопку меню со
всеми четырьмя частями и кнопку программы Мастер-класса. Ничего не перезапускает.
