...
| Мастер-класс после покупки | `backend/app/masterclass_routes.py`, `backend/app/course_structure_service.py`, `backend/app/course_structure_routes.py`, `backend/app/masterclass_offer_rules.py`, `backend/app/masterclass_offer_catalog.py`, `backend/app/static/masterclass-first-days-preview.html` | `managed_document_versions`, `masterclass_day_progress`, `masterclass_step_progress`, `masterclass_events`, `questionnaire_runs`, `questionnaire_answers`, `offer_stages`, `user_offers`, `offer_checkouts`, `masterclass_notifications`, `messenger_link_tokens` | `knowledge-base/modules/masterclass/README.md`, `knowledge-base/modules/masterclass/COURSE_STRUCTURE_CONTRACT.md`, `knowledge-base/modules/masterclass/COURSE_RUNTIME.md`, `knowledge-base/modules/masterclass/OFFERS_MODULE.md`, `knowledge-base/modules/telegram/POST_PURCHASE_MASTERCLASS.md` |
