...
Для Pikabu collector сохраняет доступные тексты комментариев, дерево ответов,
комментарии автора и отдельно два значения: заявленное число и фактически загруженное.
Динамически скрытые или недоступные ветки не подменяются выдуманными строками.
