...
Pikabu и Telegraph являются равноправными проявлениями. Одинаковый текст с
заменой одной ссылки не создаёт рабочую версию. Смысловые варианты сохраняются
отдельными проявлениями. Удаление из рабочей выдачи обратимо и не меняет
запечатанный исходный архив.
...
`preferred_basis`, предыдущие версии и дополнительные авторские источники, но
не удаляет проявления и не переопределяет семью в серверном каталоге.
