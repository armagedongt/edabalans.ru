...
3. Через две минуты от первой ошибки Worker вызывает `Campaigns.suspend` для
...
5. Реклама автоматически не возобновляется. Восстановление закрывает incident и
   сообщает, что кампании остаются остановленными до ручной проверки.
...
- 09.09.2026 — после подтверждённых разрывов маршрута между российской и
  ...
  перенесена на момент открытия incident, автовозобновление удалено.
