...
5. После трёх последовательных здоровых проверок Worker возобновляет только те
   кампании, которые сам остановил в этом incident. Кампании, остановленные вручную
   до аварии, не затрагиваются.
