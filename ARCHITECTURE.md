...
## Реализованный фундамент на 21.08.2026

- Timeweb Cloud: Ubuntu 24.04, 2 vCPU, 4 ГБ RAM, 50 ГБ NVMe;
- Caddy + автоматический HTTPS;
- FastAPI с `/health` и `/ready`;
- PostgreSQL 17 во внутренней Docker-сети без публичного 5432;
- NocoDB 2026.08.0 на `data.edabalans.ru` с закрытой регистрацией;
- ежедневный backup PostgreSQL в отдельный бакет Yandex Object Storage;
- контрольные суммы и успешное тестовое восстановление обеих баз;
- UFW, Fail2ban, автоматические обновления, ограничение Docker-логов и swap 2 ГБ.

Следующий архитектурный этап начинается только с фактических исходников приложений:
схем Google Sheets, Apps Script и Tilda T123. Перенос выполняется функция за функцией,
без преждевременной разработки Telegram-движка, MAX, нового сайта или личного кабинета.
